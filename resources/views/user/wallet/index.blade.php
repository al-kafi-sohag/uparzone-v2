                            ...
                            <div id="withdrawal-form-container" class="space-y-4">
                                <div id="main-container">
                                    ...
                                    <div>
                                        ...
                                        <input id="withdrawAmount" type="number" placeholder="Minimum 500 tk" name="amount"
                                            value="{{ old('amount') }}"
                                    ...
                                    <div>
                                        <label for="accountNumber" class="block text-sm font-medium"><span
                                                id="gatewayLabel"></span>
                                    ...
                                    <div>
                                        ...
                                        <select id="division" name="division"
                                            ...
                                            <option value="chittagong" {{ old('division') == 'chittagong' ? 'selected' : '' }}>
                                                Chittagong</option>
                                            <option value="khulna" {{ old('division') == 'khulna' ? 'selected' : '' }}>Khulna
                                            </option>
                                            <option value="rajshahi" {{ old('division') == 'rajshahi' ? 'selected' : '' }}>
                                                Rajshahi</option>
                                            <option value="barisal" {{ old('division') == 'barisal' ? 'selected' : '' }}>Barisal
                                            </option>
                                            <option value="rangpur" {{ old('division') == 'rangpur' ? 'selected' : '' }}>Rangpur
                                            </option>
                                            <option value="mymensingh" {{ old('division') == 'mymensingh' ? 'selected' : '' }}>
                                                Mymensingh</option>
                                        </select>
                                    </div>
                                    ...
                                    <button id="withdraw-button" type="submit"
                                        class="mt-4 w-full bg-teal-500 hover:bg-teal-600 text-white font-medium py-2 px-4 rounded-md d-flex justify-center align-items-center">
