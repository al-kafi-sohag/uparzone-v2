                    ...
                    <div>
                        ...
                        @else
                            <div class="flex items-center">
                                ...
                                <p id="balance" class="text-3xl font-bold text-red-500">{{ number_format($user->balance) }} tk</p>
                            </div>
                    ...
                    <div id="premium-section" class="border border-amber-200 bg-amber-50 rounded-lg p-6">
                        <div class="flex flex-col items-center text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">{{ __('Unlock withdrawal features and more benefits') }}</p>
                            </div>
