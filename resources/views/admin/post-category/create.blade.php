...
@section('title', __('Post Category Create'))

@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">{{ __('Post Category Create') }}</h1>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group align-items-center">
                        <input type="radio" class="btn-check" name="status" value="1" id="status-yes" autocomplete="off"
                            {{ old('status') == App\Models\PostCategory::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <input type="radio" class="btn-check" name="status" value="0" id="status-no" autocomplete="off"
                            {{ old('status') == App\Models\PostCategory::STATUS_INACTIVE ? 'checked' : '' }}>
