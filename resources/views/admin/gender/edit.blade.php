...
@section('title', __('Gender Edit'))

@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">{{ __('Gender Edit') }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.gender.update', $gender->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" required value="{{ old('name', $gender->name) }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group align-items-center">
                        <input type="radio" class="btn-check" name="status" value="1" id="status-yes" autocomplete="off"
                            {{ old('status', $gender->status) == App\Models\Gender::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <input type="radio" class="btn-check" name="status" value="0" id="status-no" autocomplete="off"
                            {{ old('status', $gender->status) == App\Models\Gender::STATUS_INACTIVE ? 'checked' : '' }}>
