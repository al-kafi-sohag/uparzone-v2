...
@section('title', __('Religion Create'))

@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">{{ __('Religion Create') }}</h1>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group align-items-center">
                        <input type="radio" class="btn-check" name="status" value="1" id="status-yes" autocomplete="off"
                            {{ old('status') == App\Models\Religion::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <input type="radio" class="btn-check" name="status" value="0" id="status-no" autocomplete="off"
                            {{ old('status') == App\Models\Religion::STATUS_INACTIVE ? 'checked' : '' }}>
