...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">{{ __('Mood Edit') }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.mood.update', $mood->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="order" name="order" value="{{ old('order', $mood->order) }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group align-items-center">
                        <input type="radio" class="btn-check" name="status" value="1" id="status-yes" autocomplete="off"
                            {{ old('status', $mood->status) == App\Models\Mood::STATUS_ACTIVE ? 'checked' : '' }}>
                        ...
                        <input type="radio" class="btn-check" name="status" value="0" id="status-no" autocomplete="off"
                            {{ old('status', $mood->status) == App\Models\Mood::STATUS_INACTIVE ? 'checked' : '' }}>
