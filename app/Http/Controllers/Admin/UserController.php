...
class UserController extends Controller
{
    ...
    public function addReferral(Request $request)
    {
        ...
        if ($user->is_premium) {
            ...
            $this->userTransactionService->createTransaction($referrer->id, $user->id, config('app.referral_amount'), 'Referral Reward for user ' . $user->name, UserTransaction::STATUS_COMPLETED, UserTransaction::TYPE_CREDIT, 'referral');
        }

        $referrer->save();
        $this->userTransactionService->createTransaction($referrer->id, $user->id, config('app.referral_amount'), 'Referral Reward for user ' . $user->name, UserTransaction::STATUS_PENDING, UserTransaction::TYPE_CREDIT, 'referral');
